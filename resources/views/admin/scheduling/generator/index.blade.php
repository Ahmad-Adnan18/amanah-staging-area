                    ...
                    <div class="mt-6 pt-6 border-t border-slate-200 text-center">
                        <form action="{{ route('admin.scheduling.generator.hybrid') }}" method="POST" @submit="generating = true">
                            ...
                            <div class="mb-4 text-left">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Password Generator <span class="text-red-500">*</span></label>
                                <input type="password" name="password" required class="w-full px-3 py-2 border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500" placeholder="Masukkan password untuk melanjutkan">
                            </div>
                            @endif
