<x-app-layout>
    ...
    ">
                    ...
                    <div class="space-y-3 -mt-2">
                        ...
                        // Highlight saat waktu pelajaran aktif, meskipun tidak ada jadwal
                        ...
                        <div class="rounded-2xl flex items-center transition-all duration-300 {{ $isTimeActive ? 'bg-white scale-105 shadow-xl border-red-400' : 'bg-white shadow-lg border-transparent' }} border p-3 sm:p-4">
                            {{-- Sisi Kiri: Waktu --}}
                            ...
                            <div class="w-2/3 sm:w-3/4 pl-3 sm:pl-4 border-l border-slate-200">
                                ...
                                <div class="text-xs sm:text-sm text-slate-600 flex items-center gap-x-3 mt-1">
                                    <span class="inline-flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.084-1.28-.24-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.084-1.28.24-1.857m10.416-5.408a3 3 0 11-5.832 0 3 3 0 015.832 0z"></path>
                                        </svg>{{ $schedule->kelas->nama_kelas }}</span>
                                    <span class="inline-flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        </svg>{{ $schedule->room->name }}</span>
                                </div>
                                @else
